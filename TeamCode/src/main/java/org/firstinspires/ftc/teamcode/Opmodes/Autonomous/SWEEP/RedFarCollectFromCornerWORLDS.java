...
@Autonomous(name = "PLAYOFFSRedFar3+15Corner", group = "RedAutonomous", preselectTeleOp = "RedTeleopPostAuto")
public class RedFarCollectFromCornerWORLDS extends BaseAuto {
