...
//        robot.autoMoveTo(0, 40, 135, 2);
        ...
        if (!finalLaunch) {
            robot.autoMoveTo(-15.5, -24, 236, 13);
        }else{
            robot.autoMoveTo(-37, -24, 231, 13);
        }
...
//        //The robot moves to the place to intake the balls
        ...
        detectMotifWhileMoveTo(16,-43.5,187,4);
...
//        //The robot moves to the place to intake the balls
        robot.operatorStateMachine.moveToState(OperatorStateMachine.State.INTAKE);
        robot.autoMoveTo(18.5,-41,185,4);
        robot.chill(true,0.4);
        robot.autoMoveTo(31,-42,185,4);
